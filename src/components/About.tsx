   ...
   {(!project || section !== "projects") && (
    <div className={cn(section !== "about" && "hidden sm:block fadeIn opacity-0")}>
     ...
     <p className="mt-4 sm:mt-6 max-w-[43ch] sm:max-w-[37ch] lg:max-w-prose text-stone-400 mx-auto sm:mx-0 text-[15px] sm:text-lg leading-snug sm:leading-normal">
      I&apos;m Brian Stricker, a <span className="text-white">software engineer</span> with a focus on{" "}
      <span className="text-white">web development</span>. I&apos;m based in New Jersey, and I enjoy all aspects of development, from design
      to deployment.
     </p>
    </div>
   )}
